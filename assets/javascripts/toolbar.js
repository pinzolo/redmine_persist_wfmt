...
/* Modified by pinzolo for changing format */
...
jsToolBar.prototype.elements.strong = {
  ...
  fn: {
    wiki: function() {
      if (pwfmt.isMarkdownSelected(this)) {
        this.singleTag('**');
      } else {
        this.singleTag('*');
      }
...
jsToolBar.prototype.elements.help = {
  ...
  fn: {
    wiki: function() {
      if (pwfmt.isMarkdownSelected(this)) {
        window.open(
          this.help_link.replace('wiki_syntax_textile', 'wiki_syntax_markdown'),
          '',
          'resizable=yes, location=no, width=300, height=640, menubar=no, status=no, scrollbars=yes'
        );
      } else {
        window.open(
          this.help_link.replace('wiki_syntax_markdown', 'wiki_syntax_textile'),
          '',
          'resizable=yes, location=no, width=300, height=640, menubar=no, status=no, scrollbars=yes'
        );
      }
